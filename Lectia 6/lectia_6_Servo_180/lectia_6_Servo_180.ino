...
//variabilă globală pentru Servo 180
int ServoPos = 160; //este inițializată la 160 acest parametru îl inițializați individual trebuie să corespundă cu poziția inchisă a gripperului 
